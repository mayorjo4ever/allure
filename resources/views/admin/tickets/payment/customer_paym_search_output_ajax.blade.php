      ...
      <div class="card ">
         <div class="card-body" >
            ...
            <div class="font-weight-600 text-uppercase" style="font-size: 20px">
                Total Cost:
               <?php $price = $payments['total_cost'];               
               ?>               
                {{ "N".number_format($price)}}
            </div><!-- ./  -->

            <?php $prev_pay = $payments['amount_paid'];  ?>
...
<!--                    <label class="col-md-5 font-weight-600">Discount </label>
            ...
            <div class="form-row mb-3 mt-3" id="transfermode"><div class="col-md-12 input-group">
             ...
             <div class="form-row mb-3 mt-3" id=""><div class="col-md-12 input-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <br/><br/>                        
                        <button type="button" onclick="load_organizational_bodies(),set_invoice_bill('{{$balance}}')" class="btn btn-outline-danger btn-lg w-100 font-weight-700" data-toggle="modal" data-target="#payment_invoice_modal"> Add To Invoice : {{number_format($balance)}} </button>
                        @endcan
                    </div>
            </div></div>
            </form>
                        ...
                        <div class="widget-content-outer">
                           <div class="widget-content-wrapper">
                              <div class="widget-content-left">
                                 <div class="widget-heading">Bill Cost</div>
                                 <div class="widget-subheading">Investigations, Treatment, Consultation Fees </div>
                              </div>
                              <div class="widget-content-right">
                                 <div class="widget-numbers text-dark" style="font-size: 20px">N                                   
                                    {{number_format($payments['total_cost'])}}
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            @if(!$payments['payment_completed'] && !empty($payments['payment']))
            <!--printout receipt  -->
                ...
                <!--
                 <tr>
                  ...
                  <tr>
                     ...
                     <td><?php $tests = []; $bills = []; ?>
                          <ul class="pl-3">
                        @foreach($payments['investigations'] as $spec)                       
                          <li>{{ $spec['template']['name'] }} 
                          &nbsp;   <span class="pull-right"> &#8358; {{ number_format($spec['price']) }} </span>
                          </li>
                            @endforeach
                        </ul>
                     </td>
                   ...
                   <tr>
                     <th>Drugs / Prescriptions </th>
                     <td>
                        <ul class="pl-3">
                         @foreach($payments['prescriptions'] as $l=>$prescription)
                   ...
                   <tr>
                     ...
                     <td>
                        <ul class="pl-3">
                             <?php $bills = get_general_bills($payments['bill_type_ids']); ?>
