...
<div class="row mt-0 pt-0">
    <div class="col-md-12">
        ...
        @can('create-microorganism')
       <div class="main-card ml-4 pl-4 mt-0 pt-0 mb-4 pb-4 mr-4 pr-4 card">
         <div class="card-header">{{$page_info['title']}} </div>
         <div class="card-body">
             <form class="needs-validation" novalidate="" method="post" action="{{url('admin/add-edit-micro-organism/')}}"> 
                 @csrf
            <div class="form-row">
               <div class="col-md-4 mb-3">
                  <label for="title">Micro-Organism Name </label>
                  <input type="text" name="micro_name" id="micro_name" class="form-control"  placeholder="Micro-Organism Name" required >
                  <input type="hidden" name="micro_id"  />
               ...
               <div class="col-md-4 mb-3">
                   ...
                   <select name="organism_type" id="organism_type" class="form-control text-capitalize" required="" >
                       <option value="">...</option>
                       @foreach($micro_types as $micro_type)
                       <option value="{{$micro_type}}" >{{$micro_type}} </option>
                       @endforeach
                   </select>
                  <div class="invalid-feedback">
