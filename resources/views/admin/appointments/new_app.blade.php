...
<div class="row mt-0 pt-0">
        <div class="col-md-12"> 
         ...
         <div class="main-card ml-4 pl-4 mt-0 pt-0 mb-4 pb-4 mr-4 pr-4 card">
            <div class="card-header">Search Customer
                <div class=" ml-4 pl-4 pt-3 mt-3 mb-2">                 
                    <input type="text" name="search_customer_appointment" id="search_customer_appointment" class="w-100 block form-control font-1-5rem" placeholder="Search / Filter Customers" /> 
