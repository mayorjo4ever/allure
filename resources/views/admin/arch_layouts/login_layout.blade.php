...
<html lang="en">
   ...
   <body >
      <div class="app-container app-theme-white body-tabs-shadow "  style="background:url({{asset('template/arch/assets/images/lab.jpg')}}); background-repeat: no-repeat; background-size:cover; "> <!--fixed-sidebar-->
