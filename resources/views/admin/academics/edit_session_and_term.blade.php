...
<div class="row mt-0 pt-0">
        ...
        @if(Session::has('error_message'))
          <div class="alert alert-danger fade show " role="alert"> 
              <button type="button" class="close" aria-label="Close"><span aria-hidden="true">×</span></button>
              <span class="pe-7s-attention pe-2x"></span> &nbsp;&nbsp; {{Session::get('error_message')}} 
          </div>
        @endif
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="cur_session" class="form-control" required="">
                                ...
                                <option value="{{$sess}}" @selected($calendar['current_session']==$sess) @selected(old('cur_session')==$sess) > {{$sess}} </option> 
                                @endforeach
                            </select>
